...
_vue.default.component("y-button", _button5.default);
...
}
{
  ...
  var _href = _useElement.getAttribute("xlink:href"); // console.log(useElement);
...
}
{
  ...
  var _window$getComputedSt = window.getComputedStyle(svg),
      order = _window$getComputedSt.order; // console.log(useElement);
...
}
{
  ...
  var _window$getComputedSt2 = window.getComputedStyle(_svg),
      _order = _window$getComputedSt2.order; // console.log(useElement);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10857" + '/');
